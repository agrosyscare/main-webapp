...
<div class="card shadow">
    ...
    <div class="card-body">
        ...
        <form action="{{ url('greenhouse-sections')}}" method="post">
            @csrf

            <div class="form-group">
                <label for="name_section">Nombre de sección</label>
                <input type="text" name="name_section" class="form-control" value="{{ old('name_section') }}">
            </div>

            <div class="form-group">
                <label for="planting_type">Especies plantadas</label>
                <input type="text" name="planting_type" class="form-control" value="{{ old('planting_type') }}">
            </div>
