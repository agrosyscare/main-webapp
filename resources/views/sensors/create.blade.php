    ...
    <div class="card-body">
        ...
        <form action="{{ url('sensors')}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="model_sensor" class="form-control" value="{{ old('model_sensor') }}">
            </div>

            <div class="form-group">
                <label for="serial_sensor">Número de serie</label>
                <input type="text" name="serial_sensor" class="form-control" value="{{ old('serial_sensor') }}">
            </div>
